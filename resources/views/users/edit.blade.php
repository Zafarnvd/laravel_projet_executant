            ...
            <div class="w-96 mx-auto bg-white rounded shadow">
                ...
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('edit.update',$user->id )}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="age" type="text" placeholder="Age" name="age" value="{{$user->age}}">
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="Email">Email</label>
                        <input
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="username" type="text" placeholder="Email" name="email" value="{{$user->email}}">
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="role">Role</label>
                        <select
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="role" type="select" placeholder="Role" name="role_id" value="{{$user->role}}">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            id="avatar" type="file" placeholder="Avatar" name="avatar" value="{{$user->avatar}}"> --}}
                    </div>
