                ...
                <table class="max-w-5xl mx-auto table-auto">
                    <thead class="justify-between">
                        <tr class="bg-green-600">
                            ...
                            <th class="px-16 py-2">
                                <span class="text-gray-100 font-semibold">Prenom</span>
                            </th>

                            <th class="px-16 py-2">
                                <span class="text-gray-100 font-semibold">Age</span>
                            </th>
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="bg-white border-b-2 border-gray-200">
                            <td class="px-16 py-2 flex flex-row items-center">
                                <img src="{{asset('/storage'.$item->avatar->img)}}" alt="" class="rounded-full">
                            </td>
                            <td>
                            ...
                            <td class="px-16 py-2">
                                <span>
                                    ...
                                    <form method="POST" action="/users/delete/{{$item->id}}">
                                        @csrf
                                        @method('delete')
